...
RETRY_DELAY_CAP = 60
CALL_DEADLINE = float(os.environ.get("AGENT_CALL_DEADLINE", "180"))
RUN_TIMEOUT = float(os.environ.get("AGENT_RUN_TIMEOUT", "900"))
WATCHDOG_GRACE = float(os.environ.get("AGENT_WATCHDOG_GRACE", "15"))
ASK_TIMEOUT = float(os.environ.get("AGENT_ASK_TIMEOUT", "120"))
